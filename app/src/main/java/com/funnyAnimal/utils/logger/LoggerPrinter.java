package com.funnyAnimal.utils.logger;
    ...
    public void object(Object object) {
        if (object != null) {
            ...
            if (object.getClass().isArray()) {
                ...
                String msg = "%s size = %d [\n";
                msg = String.format(Locale.CHINA, msg, simpleName, collection.size());
                if (!collection.isEmpty()) {
                    ...
                    while (iterator.hasNext()) {
                        ...
                        msg += String.format(Locale.CHINA, itemString, flag, SystemUtil.objectToString(item),
