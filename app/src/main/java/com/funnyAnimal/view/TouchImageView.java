...
public class TouchImageView extends ImageView {
            ...
            if (state == STATE_NONE || state == STATE_DRAG || state == STATE_FLING) {
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if (fling != null)
                            fling.cancelFling();
                        TouchImageView.this.setState(STATE_DRAG);
                        break;
    ...
    private class ScaleListener extends ScaleGestureDetector.SimpleOnScaleGestureListener {
        ...
        public boolean onScaleBegin(ScaleGestureDetector detector) {
            TouchImageView.this.setState(STATE_ZOOM);
            return true;
        }
        ...
        public void onScaleEnd(ScaleGestureDetector detector) {
            ...
            TouchImageView.this.setState(STATE_NONE);
    ...
    private class DoubleTapZoom implements Runnable {
        ...
        DoubleTapZoom(float targetZoom, float focusX, float focusY, boolean stretchImageToSuper) {
            TouchImageView.this.setState(STATE_ANIMATE_ZOOM);
    ...
    private class Fling implements Runnable {
        ...
        Fling(int velocityX, int velocityY) {
            TouchImageView.this.setState(STATE_FLING);
    ...
    private void printMatrixInfo() {
        float[] n = new float[9];
        matrix.getValues(n);
        //LogUtils.d("Scale: " + n[Matrix.MSCALE_X] + " TransX: " + n[Matrix.MTRANS_X] + " TransY: " + n[Matrix.MTRANS_Y]);
    }
}
